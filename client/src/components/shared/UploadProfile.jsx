...
const UploadProfile = ({mediaUrl,setImage}) => {
  ...
  return (
    <div  {...getRootProps()}>
         ...
         <div className="flex items-center gap-4 cursor-pointer">
            <img className='rounded-full w-[75px] h-[75px] object-top object-contain ' src={fileUrl || "https://www.github.com/shadcn.png"} alt="profile" />
